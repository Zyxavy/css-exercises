...
### Self Check
- Did you properly chain class selectors for each rule? O
- Does the `proportioned` image retain its original square proportions? O
- Does the `distorted` image end up looking squished and, well, distorted? O
