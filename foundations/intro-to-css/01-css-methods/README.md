...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? O
- Did you properly link the external CSS file in the HTML file? O
- Does the `div` element have CSS added via the external method? O
- Does the `p` element have CSS added via the internal method? O
- Does the `button` element have CSS added via the inline method? O
