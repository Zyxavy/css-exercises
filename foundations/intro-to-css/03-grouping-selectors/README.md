...
- Does each element have a unique class name? O
- Did you use the grouping selector for styles that both elements share? O
- Did you make separate rules for the styles unique to each element? O
